        ...
        <div class="col-lg-9">
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark py-3 py-lg-0 px-0">
                <a href="" class="text-decoration-none d-block d-lg-none">
                    <span class="h1 text-uppercase text-dark bg-light px-2">@yield('naziv_jedan')</span>
                    <span class="h1 text-uppercase text-light bg-primary px-2 ml-n1">@yield('naziv_dva')</span>
                </a>
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    ...
                    <div class="navbar-nav ml-auto py-0  d-lg-block">
                        ...
                        <a href="{{route('cartView')}}" class="btn px-0 ml-3 nav-item" style="color: white">
