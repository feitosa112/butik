...
Route::post('/delete-productCart/{id}',[ProductController::class,'deleteProductFromCart'])->name('deleteProductFromCart');
Route::post('/checkout-view',[ProductController::class,'checkoutView'])->name('checkoutView');
